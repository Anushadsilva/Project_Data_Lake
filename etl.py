...
def process_song_data(spark, input_data, output_data):
    ...
    df = spark.read.json("s3a://udacity-dend/song-data/A/A/A/TRAAAAK128F9318786.json")
    df.show()
...
def process_log_data(spark, input_data, output_data):
    ...
    df = spark.read.json("s3a://udacity-dend/log_data/2018/11/2018-11-12-events.json")
...
def main():
    ...
    output_data = "s3a://dend-anu/"
    
    print('started processing for songdata: ' + str(datetime.now()))
    process_song_data(spark, input_data, output_data)
    print('song data processing complete: ' + str(datetime.now()))
    print('starting processing for log data: ' + str(datetime.now()))
